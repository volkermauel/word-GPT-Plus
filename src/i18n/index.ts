...
const messages = {
  en: {
    ...
    openwebCollectionsLabel: 'Collections',
    openwebCollectionsPlaceholder: 'collection names',
    openwebTokenLabel: 'Access Token',
    openwebTokenPlaceholder: 'token',
    ...
    settingOpenwebEndpoint: 'endpoint',
    settingProxy: 'Proxy',
  ...
  'zh-cn': {
    ...
    openwebTemperatureLabel: 'temperature',
    openwebCollectionsLabel: '知识库',
    openwebCollectionsPlaceholder: '集合名称',
    openwebTokenLabel: '访问令牌',
    openwebTokenPlaceholder: 'token',
