...
const messages = {
  en: {
    ...
    openwebEndpointLabel: 'endpoint',
    openwebEndpointPlaceholder: 'endpoint',
    openwebAPIKeyLabel: 'API Key',
    openwebAPIKeyPlaceholder: 'API key for openweb',
    openwebCustomModelLabel: 'Custom Model',
    openwebCustomModelPlaceholder: 'Please input model',
    openwebModelSelectLabel: 'Model',
    openwebModelSelectPlaceholder: 'Please select model',
    openwebTemperatureLabel: 'Temperature',
    openwebCollectionLabel: 'Collection',
    openwebCollectionPlaceholder: 'Please select collection',
    translate: 'Translate',
    summary: 'Summary',
    polish: 'Polish',
    grammar: 'Grammar',
  ...
  'zh-cn': {
    ...
    openwebEndpointLabel: 'endpoint',
    openwebEndpointPlaceholder: 'endpoint',
    openwebAPIKeyLabel: 'API 密钥',
    openwebAPIKeyPlaceholder: 'API 密钥',
    openwebCustomModelLabel: '自定义模型',
    openwebCustomModelPlaceholder: '请输入模型',
    openwebModelSelectLabel: '选择模型',
    openwebModelSelectPlaceholder: '请选择模型',
    openwebTemperatureLabel: 'temperature',
    openwebCollectionLabel: '知识库',
    openwebCollectionPlaceholder: '请选择知识库',
    translate: '翻译',
    summary: '摘要',
    polish: '润色',
    grammar: '语法',
